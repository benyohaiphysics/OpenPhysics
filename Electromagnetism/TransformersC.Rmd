...
plotstring<-paste(i,")\\newline",sprintf(template,primarySpacing[2],primarySpacing[3],paste(" = \\SI{",formatEng(signif(primaryCurrent,2)),"}{\\ampere}"),if(hidePrimary==TRUE)("")else(paste(" = \\SI{",formatEng(signif(primaryVoltage,2)),"}{\\volt}")),paste(" = \\SI{",formatEng(signif(secondaryCurrent,2)),"}{\\ampere}"),secondarySpacing[2],secondarySpacing[3],if(hidePrimary==FALSE)("")else(paste(" = \\SI{",formatEng(signif(secondaryVoltage,2)),"}{\\volt}")),sep=""))
