...
plotstring<-paste(i,")\\newline",sprintf(template,primarySpacing[2],primarySpacing[3],if(hidePrimary==TRUE)("")else(paste(" = \\SI{",formatEng(signif(primaryCurrent,2)),"}{\\ampere}")),if(hidePrimary==FALSE)("")else(paste(" = \\SI{",formatEng(signif(secondaryCurrent,2)),"}{\\ampere}")),secondarySpacing[2],secondarySpacing[3],paste("= ",primaryTurns," turns"),paste("= ",secondaryTurns," turns"),sep=""))
