...
Calculate the unknown force in each of the hydraulic systems below;
...
plotstring<-paste(i,")\\newline",sprintf(template,primaryWidth,secondaryWidth,arrowSWidth,arrowPWidth,if(hidePrimary==TRUE)("$F_1$")else(paste("\\SI{",formatEng(signif(primaryForce,3)),"}{\\newton}")),if(hidePrimary==FALSE)("$F_2$")else(paste("\\SI{",formatEng(signif(primaryForce,3)),"}{\\newton}")),paste("\\SI{",formatEng(signif(primaryArea,3)),"}{\\metre\\squared}"),paste("\\SI{",formatEng(signif(secondaryArea,3)),"}{\\metre\\squared}"),sep=""))
...
answers<-c(answers,if(hidePrimary==TRUE)(paste("$F_1$ = \\SI{",formatEng(signif(primaryForce,2)),"}{\\newton}"))else(paste("$F_2$ = \\SI{",formatEng(signif(secondaryForce,2)),"}{\\newton}")))
